...
def test_repositories0():
    ...
    JAVACRIPT_VERSION = "84990d363c5c57873971533a52d85cf88eef1ad5"

    http_archive(
        name = "better_rules_javascript",
        sha256 = "b1524bc2ccac9f04729ec986c70d1f2341916b82aee296fc779125a6eef3a899",
        strip_prefix = "rules_javascript-%s" % JAVACRIPT_VERSION,
        url = "https://github.com/rivethealth/rules_javascript/archive/%s.zip" % JAVACRIPT_VERSION,
    )
