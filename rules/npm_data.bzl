PACKAGES = [
    {
        "deps": [
            ...
            {
                "dep": "strip-json-comments@3.1.1",
                "name": "strip-json-comments",
            },
        ],
        "extra_deps": {},
        "id": "@eslint/eslintrc@1.0.5",
    ...
    },
    {
        "deps": [
            {
                "dep": "@humanwhocodes/object-schema@1.2.1",
    ...
    },
    {
        "deps": [
            {
                "dep": "@nodelib/fs.stat@2.0.5",
                "name": "@nodelib/fs.stat",
            },
            {
                "dep": "run-parallel@1.2.0",
                "name": "run-parallel",
            },
        ],
        "extra_deps": {},
    ...
    },
    {
        "deps": [
            {
                "dep": "@textlint/ast-node-types@4.4.3",
                "name": "@textlint/ast-node-types",
            },
            {
                "dep": "debug@4.3.3",
            ...
            {
                "dep": "remark-frontmatter@1.3.3",
                "name": "remark-frontmatter",
            },
            {
                "dep": "remark-parse@5.0.0",
                "name": "remark-parse",
            },
            {
                "dep": "structured-source@3.0.2",
    ...
    },
    {
        "deps": [
            {
                "dep": "@types/node@17.0.4",
                "name": "@types/node",
            },
        ],
        "extra_deps": {},
        "id": "@types/node-sass@4.11.2",
        "name": "@types/node-sass",
        "url": "https://registry.npmjs.org/@types/node-sass/-/node-sass-4.11.2.tgz",
    },
    {
        "deps": [],
        "extra_deps": {},
        "id": "@types/node@17.0.4",
        "name": "@types/node",
    ...
    },
    {
        "deps": [
            {
                "dep": "@types/node-sass@4.11.2",
                "name": "@types/node-sass",
            },
            {
                "dep": "@types/sass@1.43.1",
                "name": "@types/sass",
            },
            {
                "dep": "@types/webpack@4.41.32",
                "name": "@types/webpack",
            },
        ],
        "extra_deps": {},
        "id": "@types/sass-loader@8.0.2",
        "name": "@types/sass-loader",
        "url": "https://registry.npmjs.org/@types/sass-loader/-/sass-loader-8.0.2.tgz",
    },
    {
        "deps": [
            {
    ...
    },
    {
        "deps": [],
        "extra_deps": {},
        "id": "@types/source-list-map@0.1.2",
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "@types/source-list-map@0.1.2",
                "name": "@types/source-list-map",
            },
            {
        ...
        "extra_deps": {},
        "id": "@types/webpack-sources@3.2.0",
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "@types/tapable@1.0.8",
                "name": "@types/tapable",
            },
            {
                "dep": "@types/uglify-js@3.13.1",
                "name": "@types/uglify-js",
            },
            {
                "dep": "@types/webpack-sources@3.2.0",
                "name": "@types/webpack-sources",
            },
            {
                "dep": "anymatch@3.1.2",
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "functional-red-black-tree@1.0.1",
        ...
        "extra_deps": {},
        "id": "@typescript-eslint/eslint-plugin@5.5.0",
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "eslint-scope@5.1.1",
                "name": "eslint-scope",
            },
            {
                "dep": "eslint-utils@3.0.0",
                "name": "eslint-utils",
            },
            {
                "dep": "eslint@8.3.0",
        ...
        "extra_deps": {},
        "id": "@typescript-eslint/experimental-utils@5.5.0",
        "name": "@typescript-eslint/experimental-utils",
    ...
    },
    {
        ...
        "extra_deps": {},
        "id": "@typescript-eslint/parser@5.5.0",
        "name": "@typescript-eslint/parser",
    ...
    },
    {
        ...
        "extra_deps": {},
        "id": "@typescript-eslint/typescript-estree@5.5.0",
        "name": "@typescript-eslint/typescript-estree",
    ...
    },
    {
        "deps": [
            {
                "dep": "clean-stack@2.2.0",
                "name": "clean-stack",
            },
            {
                "dep": "indent-string@4.0.0",
                "name": "indent-string",
            },
        ],
        "extra_deps": {},
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "json-schema-traverse@0.4.1",
    ...
    },
    {
        "deps": [
            {
                "dep": "balanced-match@1.0.2",
                "name": "balanced-match",
            },
            {
                "dep": "concat-map@0.0.1",
                "name": "concat-map",
            },
        ],
        "extra_deps": {},
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "minipass-collect@1.0.2",
                "name": "minipass-collect",
            },
            {
                "dep": "minipass-flush@1.0.5",
                "name": "minipass-flush",
            },
            {
                "dep": "minipass-pipeline@1.2.4",
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "glob-parent@5.1.2",
                "name": "glob-parent",
            },
            {
                "dep": "is-binary-path@2.1.0",
                "name": "is-binary-path",
            },
            {
                "dep": "is-glob@4.0.3",
    ...
    },
    {
        "deps": [
            {
                "dep": "@textlint/markdown-to-ast@6.1.7",
                "name": "@textlint/markdown-to-ast",
            },
            {
                "dep": "anchor-markdown-header@0.5.7",
                "name": "anchor-markdown-header",
            },
            {
                "dep": "htmlparser2@4.1.0",
                "name": "htmlparser2",
            },
            {
                "dep": "minimist@1.2.5",
            ...
            {
                "dep": "underscore@1.12.1",
                "name": "underscore",
            },
            {
                "dep": "update-section@0.3.3",
                "name": "update-section",
            },
        ],
        "extra_deps": {},
    ...
    },
    {
        "deps": [
            {
                "dep": "@eslint/eslintrc@1.0.5",
                "name": "@eslint/eslintrc",
            },
            {
                "dep": "@humanwhocodes/config-array@0.6.0",
                "name": "@humanwhocodes/config-array",
            },
            {
                "dep": "ajv@6.12.6",
            ...
            {
                "dep": "escape-string-regexp@4.0.0",
                "name": "escape-string-regexp",
            },
            {
            ...
            {
                "dep": "json-stable-stringify-without-jsonify@1.0.1",
            ...
            {
                "dep": "text-table@0.2.0",
                "name": "text-table",
            },
            {
                "dep": "v8-compile-cache@2.3.0",
                "name": "v8-compile-cache",
            },
        ],
        "extra_deps": {
            "eslint-utils": "eslint-utils@3.0.0",
        },
        "id": "eslint@8.3.0",
        "name": "eslint",
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "color-support@1.1.3",
                "name": "color-support",
            },
            {
                "dep": "console-control-strings@1.1.0",
                "name": "console-control-strings",
            },
            {
                "dep": "has-unicode@2.0.1",
                "name": "has-unicode",
            },
            {
    ...
    },
    {
        "deps": [
            {
                "dep": "@tootallnate/once@1.1.2",
                "name": "@tootallnate/once",
            },
            {
                "dep": "agent-base@6.0.2",
                "name": "agent-base",
            },
            {
                "dep": "debug@4.3.3",
    ...
    },
    {
        "deps": [
            {
                "dep": "parent-module@1.0.1",
                "name": "parent-module",
            },
            {
                "dep": "resolve-from@4.0.0",
                "name": "resolve-from",
            },
        ],
        "extra_deps": {},
    ...
    },
    {
        "deps": [
            {
                "dep": "is-alphabetical@1.0.4",
                "name": "is-alphabetical",
            },
            {
                "dep": "is-decimal@1.0.4",
                "name": "is-decimal",
            },
        ],
        "extra_deps": {},
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "http-cache-semantics@4.1.0",
                "name": "http-cache-semantics",
            },
            {
            ...
            {
                "dep": "negotiator@0.6.2",
                "name": "negotiator",
            },
            {
                "dep": "promise-retry@2.0.1",
                "name": "promise-retry",
            },
            {
                "dep": "socks-proxy-agent@6.1.1",
    ...
    },
    {
        "deps": [
            {
                "dep": "character-entities@1.2.4",
                "name": "character-entities",
            },
            {
                "dep": "character-entities-legacy@1.1.4",
                "name": "character-entities-legacy",
            },
            {
                "dep": "character-reference-invalid@1.1.4",
                "name": "character-reference-invalid",
            },
            {
                "dep": "is-alphanumerical@1.0.4",
                "name": "is-alphanumerical",
            },
            {
                "dep": "is-decimal@1.0.4",
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "string_decoder@1.3.0",
                "name": "string_decoder",
            },
            {
                "dep": "util-deprecate@1.0.2",
                "name": "util-deprecate",
            },
        ],
        "extra_deps": {},
    ...
    },
    {
        "deps": [
            {
                "dep": "collapse-white-space@1.0.6",
                "name": "collapse-white-space",
            },
            {
                "dep": "is-alphabetical@1.0.4",
            ...
            {
                "dep": "is-whitespace-character@1.0.4",
                "name": "is-whitespace-character",
            },
            {
                "dep": "is-word-character@1.0.4",
                "name": "is-word-character",
            },
            {
                "dep": "markdown-escapes@1.0.4",
                "name": "markdown-escapes",
            },
            {
                "dep": "parse-entities@1.2.2",
                "name": "parse-entities",
            },
            {
                "dep": "repeat-string@1.6.1",
                "name": "repeat-string",
            },
            {
                "dep": "state-toggle@1.0.3",
                "name": "state-toggle",
            },
            {
                "dep": "trim@0.0.1",
            ...
            {
                "dep": "unist-util-remove-position@1.1.4",
                "name": "unist-util-remove-position",
            },
            {
                "dep": "vfile-location@2.0.6",
                "name": "vfile-location",
            },
            {
                "dep": "xtend@4.0.2",
    ...
    },
    {
        "deps": [
            ...
            {
                "dep": "is-fullwidth-code-point@3.0.0",
                "name": "is-fullwidth-code-point",
            },
            {
                "dep": "strip-ansi@6.0.1",
    ...
    },
    {
        "deps": [
            {
                "dep": "unist-util-visit-parents@2.1.2",
                "name": "unist-util-visit-parents",
            },
        ],
        "extra_deps": {},
    ...
    },
    {
        "deps": [
            {
                "dep": "unist-util-stringify-position@1.1.2",
                "name": "unist-util-stringify-position",
            },
        ],
        "extra_deps": {},
...
ROOTS = [
    {
        "dep": "@types/argparse@2.0.10",
        "name": "@types/argparse",
    },
    {
        "dep": "@types/sass-loader@8.0.2",
        "name": "@types/sass-loader",
    },
    {
